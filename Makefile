...
# coq_makefile Arith.v Exceptions.v ExceptionsTwoCont.v Heap.v Lambda.v LambdaCBNeed.v LambdaExceptions.v ListIndex.v Loop.v StateGlobal.v StateGlobalSeq.v StateLocal.v Tactics.v -o Makefile 
#
